    ...
    return (
        <>
            ...
            <div className="Signin-container">
                ...
                <button className='accbutton' onClick={saveStorage}>Create Account</button>
                <Link to='/Login' style={{textDecoration:"none",marginLeft:"130px",marginTop:"20px",color:"black"}}>Log in</Link>
            </div>
        </>
    )
}
