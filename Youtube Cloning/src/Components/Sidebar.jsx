...
function Sidebar() {
  return (
    <div className='sidebar'> 
      <div className='item'><i className="fa-regular fa-house" style={{color: "#000000",}}></i><span>Home</span></div>
      <div className='item'><img src={shorts}></img><span>Shorts</span></div>
      <div className='item'><img src={sub}></img><span>Subscriptions</span></div>
      <hr></hr>
      <h3>You</h3>
      <br></br>
      <div className='item'><i className="fa-solid fa-clock-rotate-left" style={{color: "#000000",}}></i><span>History</span></div>
